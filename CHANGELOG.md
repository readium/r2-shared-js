...
Git diff:
* https://github.com/readium/r2-shared-js/compare/v1.0.85...develop
...
> Build environment: NodeJS `22.20.0`, NPM `11.6.2`

Changes:
* NPM package updates
* Fix: handling of encrypted pages.xml pagemap (empty page list of page breaks)

Git revision info:
* https://unpkg.com/r2-shared-js@1.0.85/dist/gitrev.json
* https://github.com/edrlab/r2-shared-js-dist/blob/v1.0.85/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-shared-js/commits/v1.0.85`

Git diff:
* https://github.com/readium/r2-shared-js/compare/v1.0.84...v1.0.85
...
Git revision info:
* https://unpkg.com/r2-shared-js@1.0.83/dist/gitrev.json
* https://github.com/edrlab/r2-shared-js-dist/blob/v1.0.83/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-shared-js/commits/v1.0.83

Git diff:
* https://github.com/readium/r2-shared-js/compare/v1.0.82...v1.0.83
...
Git revision info:
* https://unpkg.com/r2-shared-js@1.0.82/dist/gitrev.json
* https://github.com/edrlab/r2-shared-js-dist/blob/v1.0.82/dist/gitrev.json

Git commit history:
* https://github.com/readium/r2-shared-js/commits/v1.0.82

Git diff:
* https://github.com/readium/r2-shared-js/compare/v1.0.81...v1.0.82
